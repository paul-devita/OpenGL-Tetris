...
void ui_render() {
	...
	p_drawDummy(P_I_PIECE, &UI_STATS_I_ELEMENT_BLOCK_POSITION, UI_STATS_ELEMENT_BLOCK_SIZE, COLOR_INDEX_BLUE);
	...
	p_drawDummy(P_J_PIECE, &UI_STATS_J_ELEMENT_BLOCK_POSITION, UI_STATS_ELEMENT_BLOCK_SIZE, COLOR_INDEX_TEAL);
	...
	p_drawDummy(P_L_PIECE, &UI_STATS_L_ELEMENT_BLOCK_POSITION, UI_STATS_ELEMENT_BLOCK_SIZE, COLOR_INDEX_ORANGE);
	...
	p_drawDummy(P_O_PIECE, &UI_STATS_O_ELEMENT_BLOCK_POSITION, UI_STATS_ELEMENT_BLOCK_SIZE, COLOR_INDEX_YELLOW);
	...
	p_drawDummy(P_S_PIECE, &UI_STATS_S_ELEMENT_BLOCK_POSITION, UI_STATS_ELEMENT_BLOCK_SIZE, COLOR_INDEX_RED);
	...
	p_drawDummy(P_T_PIECE, &UI_STATS_T_ELEMENT_BLOCK_POSITION, UI_STATS_ELEMENT_BLOCK_SIZE, COLOR_INDEX_PURPLE);
	...
	p_drawDummy(P_Z_PIECE, &UI_STATS_Z_ELEMENT_BLOCK_POSITION, UI_STATS_ELEMENT_BLOCK_SIZE, COLOR_INDEX_GREEN);
}
