...
void ui_init() {
	if (!UI_INITIALIZED) {
		//Score Box
			//Box
			UI_SCORE_BOX_POSITION.x = 7 * SCR_WIDTH / (float)8;
			UI_SCORE_BOX_POSITION.y = 7 * SCR_HEIGHT / (float)10;

			UI_SCORE_BOX_SCALE.x = SCR_WIDTH / (float)5;
			UI_SCORE_BOX_SCALE.y = SCR_HEIGHT / (float)2;

			//Title
			unsigned int UI_SCORE_TITLE_TEXT_LENGTH = 0;
			for (int i = 0; UI_SCORE_TITLE_TEXT[i] != '\0'; i++)
				UI_SCORE_TITLE_TEXT_LENGTH++;

			UI_SCORE_TITLE_TEXT_POSITION.x = UI_SCORE_BOX_POSITION.x;
			UI_SCORE_TITLE_TEXT_POSITION.y = UI_SCORE_BOX_POSITION.y - 3 * UI_SCORE_BOX_SCALE.y / (float)8;

			UI_SCORE_TITLE_TEXT_SCALE.x = (3 * UI_SCORE_BOX_SCALE.x) / (float)(4 * UI_SCORE_TITLE_TEXT_LENGTH) - ((UI_SCORE_TITLE_TEXT_LENGTH - 1) * UI_TEXT_CHAR_SPACING) / (float)UI_SCORE_TITLE_TEXT_LENGTH;
			...
			UI_SCORE_TEXT_SCALE.x = (3 * UI_SCORE_BOX_SCALE.x) / (float)(4 * UI_GAME_SCORE_TEXT_LENGTH) - ((UI_GAME_SCORE_TEXT_LENGTH - 1) * UI_TEXT_CHAR_SPACING) / (float)UI_GAME_SCORE_TEXT_LENGTH;
			UI_SCORE_TEXT_SCALE.y = UI_TEXT_HEIGHT;

		//Next Box
			//Box
			UI_NEXT_BOX_POSITION.x = 7 * SCR_WIDTH / (float)8;
			UI_NEXT_BOX_POSITION.y = 9 * SCR_HEIGHT / (float)40;

			UI_NEXT_BOX_SCALE.x = SCR_WIDTH / (float)5;
			UI_NEXT_BOX_SCALE.y = 7 * SCR_HEIGHT / (float)20;

			//Title
			unsigned int UI_NEXT_TITLE_TEXT_LENGTH = 0;
			for (int i = 0; UI_SCORE_TITLE_TEXT[i] != TP_NULL; i++)
				UI_NEXT_TITLE_TEXT_LENGTH++;

			UI_NEXT_TITLE_TEXT_POSITION.x = UI_NEXT_BOX_POSITION.x;
			UI_NEXT_TITLE_TEXT_POSITION.y = UI_NEXT_BOX_POSITION.y - UI_NEXT_BOX_SCALE.y / (float)4;

			UI_NEXT_TITLE_TEXT_SCALE.x = (3 * UI_NEXT_BOX_SCALE.x) / (float)(4 * UI_NEXT_TITLE_TEXT_LENGTH) - ((UI_NEXT_TITLE_TEXT_LENGTH - 1) * UI_TEXT_CHAR_SPACING) / (float)UI_NEXT_TITLE_TEXT_LENGTH;
			UI_NEXT_TITLE_TEXT_SCALE.y = UI_TEXT_HEIGHT;

			//Piece
			UI_NEXT_BLOCK_POSITION.x = UI_NEXT_BOX_POSITION.x;
			UI_NEXT_BLOCK_POSITION.y = UI_NEXT_BOX_POSITION.y + UI_NEXT_BOX_SCALE.y / (float)8;
		...
		//Hold Box
			//Box
			UI_HOLD_BOX_POSITION.x = SCR_WIDTH / (float)8;
			UI_HOLD_BOX_POSITION.y = 9 * SCR_HEIGHT / (float)40;

			UI_HOLD_BOX_SCALE.x = SCR_WIDTH / (float)5;
			UI_HOLD_BOX_SCALE.y = 7 * SCR_HEIGHT / (float)20;

			//Title
			unsigned int UI_HOLD_TITLE_TEXT_LENGTH = 0;
			for (int i = 0; UI_HOLD_TITLE_TEXT[i] != '\0'; i++)
				UI_HOLD_TITLE_TEXT_LENGTH++;

			UI_HOLD_TITLE_TEXT_POSITION.x = UI_HOLD_BOX_POSITION.x;
			UI_HOLD_TITLE_TEXT_POSITION.y = UI_HOLD_BOX_POSITION.y - UI_HOLD_BOX_SCALE.y / (float)4;

			UI_HOLD_TITLE_TEXT_SCALE.x = (3 * UI_HOLD_BOX_SCALE.x) / (float)(4 * UI_NEXT_TITLE_TEXT_LENGTH) - ((UI_NEXT_TITLE_TEXT_LENGTH - 1) * UI_TEXT_CHAR_SPACING) / (float)UI_NEXT_TITLE_TEXT_LENGTH;
		...
		//Stats Box
			//Box
			UI_STATS_BOX_POSITION.x = SCR_WIDTH / (float)8;
			UI_STATS_BOX_POSITION.y = 7 * SCR_HEIGHT / (float)10;

			UI_STATS_BOX_SCALE.x = SCR_WIDTH / (float)5;
			UI_STATS_BOX_SCALE.y = SCR_HEIGHT / (float)2;

			UI_HOLD_PIECE_SIZE = (5 * UI_HOLD_BOX_SCALE.x) / (float)(8 * P_BLOCK_COUNT);

			//Title
			unsigned int G_GAME_STATS_TITLE_TEXT_LENGTH = 0;
			for (int i = 0; UI_STATS_TITLE_TEXT[i] != TP_NULL; i++)
				G_GAME_STATS_TITLE_TEXT_LENGTH++;

			UI_STATS_TITLE_TEXT_POSITION.x = UI_STATS_BOX_POSITION.x;
			UI_STATS_TITLE_TEXT_POSITION.y = UI_STATS_BOX_POSITION.y - 3 * UI_STATS_BOX_SCALE.y / (float)8;

			UI_STATS_TITLE_TEXT_SCALE.x = (3 * UI_STATS_BOX_SCALE.x) / (float)(4 * G_GAME_STATS_TITLE_TEXT_LENGTH) - ((G_GAME_STATS_TITLE_TEXT_LENGTH - 1) * UI_TEXT_CHAR_SPACING) / (float)G_GAME_STATS_TITLE_TEXT_LENGTH;
			...
			UI_STATS_ELEMENT_TEXT_CHAR_SCALE.y = (3 * UI_STATS_ELEMENT_SCALE.y) / (float)4;

			UI_STATS_ELEMENT_BLOCK_SIZE = (2 * UI_STATS_ELEMENT_SCALE.x) / (float)20;

			//I Block
			UI_STATS_I_ELEMENT_TEXT_POSITION.x = UI_STATS_BOX_POSITION.x + UI_STATS_ELEMENT_SCALE.x / (float)5;
			UI_STATS_I_ELEMENT_TEXT_POSITION.y = UI_STATS_BOX_POSITION.y + UI_STATS_BOX_SCALE.y / (float)16 - (9 * UI_STATS_ELEMENT_SCALE.y) / (float)2 - 3 * UI_STATS_ELEMENT_SPACING;
			...
			//J Block
			UI_STATS_J_ELEMENT_TEXT_POSITION.x = UI_STATS_BOX_POSITION.x + UI_STATS_ELEMENT_SCALE.x / (float)5;
			UI_STATS_J_ELEMENT_TEXT_POSITION.y = UI_STATS_BOX_POSITION.y + UI_STATS_BOX_SCALE.y / (float)16 - (6 * UI_STATS_ELEMENT_SCALE.y) / (float)2 - 2 * UI_STATS_ELEMENT_SPACING;
			...
			//L Block
			UI_STATS_L_ELEMENT_TEXT_POSITION.x = UI_STATS_BOX_POSITION.x + UI_STATS_ELEMENT_SCALE.x / (float)5;
			UI_STATS_L_ELEMENT_TEXT_POSITION.y = UI_STATS_BOX_POSITION.y + UI_STATS_BOX_SCALE.y / (float)16 - (3 * UI_STATS_ELEMENT_SCALE.y) / (float)2 - UI_STATS_ELEMENT_SPACING;
			...
			//O Block
			UI_STATS_O_ELEMENT_TEXT_POSITION.x = UI_STATS_BOX_POSITION.x + UI_STATS_ELEMENT_SCALE.x / (float)5;
			UI_STATS_O_ELEMENT_TEXT_POSITION.y = UI_STATS_BOX_POSITION.y + UI_STATS_BOX_SCALE.y / (float)16;
			...
			//S Block
			UI_STATS_S_ELEMENT_TEXT_POSITION.x = UI_STATS_BOX_POSITION.x + UI_STATS_ELEMENT_SCALE.x / (float)5;
			UI_STATS_S_ELEMENT_TEXT_POSITION.y = UI_STATS_BOX_POSITION.y + UI_STATS_BOX_SCALE.y / (float)16 + (3 * UI_STATS_ELEMENT_SCALE.y) / (float)2 + UI_STATS_ELEMENT_SPACING;
			...
			//T Block
			UI_STATS_T_ELEMENT_TEXT_POSITION.x = UI_STATS_BOX_POSITION.x + UI_STATS_ELEMENT_SCALE.x / (float)5;
			UI_STATS_T_ELEMENT_TEXT_POSITION.y = UI_STATS_BOX_POSITION.y + UI_STATS_BOX_SCALE.y / (float)16 + (6 * UI_STATS_ELEMENT_SCALE.y) / (float)2 + 2 * UI_STATS_ELEMENT_SPACING;
			...
			//Z Block
			UI_STATS_Z_ELEMENT_TEXT_POSITION.x = UI_STATS_BOX_POSITION.x + UI_STATS_ELEMENT_SCALE.x / (float)5;
			UI_STATS_Z_ELEMENT_TEXT_POSITION.y = UI_STATS_BOX_POSITION.y + UI_STATS_BOX_SCALE.y / (float)16 + (9 * UI_STATS_ELEMENT_SCALE.y) / (float)2 + 3 * UI_STATS_ELEMENT_SPACING;
