...
void g_init() {
	...
	//Game State
		...
		//Grid
			G_GRID_POSITION.x = SCR_WIDTH / (float)2;
			G_GRID_POSITION.y = SCR_HEIGHT / (float)2;

			G_GRID_SCALE.x = (9 * SCR_WIDTH) / (float)20;
			G_GRID_SCALE.y = 2 * G_GRID_SCALE.x;

			G_GRID_LOWER_LEFT.x = G_GRID_POSITION.x - (G_GRID_SCALE.x / (float)2);
			G_GRID_LOWER_LEFT.y = G_GRID_POSITION.y + (G_GRID_SCALE.y / (float)2);
